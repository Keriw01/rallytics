...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "liveScoresMatchStatusFinished": MessageLookupByLibrary.simpleMessage(
      "Zakończone",
    ),
    "liveScoresMatchStatusUpcoming": MessageLookupByLibrary.simpleMessage(
      "Nadchodzące",
    ),
    "liveScoresTitle": MessageLookupByLibrary.simpleMessage("Wyniki na Żywo"),
    ...
    "trainingSessionImportButton": MessageLookupByLibrary.simpleMessage(
      "Importuj z Galerii",
    ),
    "trainingSessionStartButton": MessageLookupByLibrary.simpleMessage(
      "Zacznij Nagrywanie",
    ),
    "trainingSessionTitle": MessageLookupByLibrary.simpleMessage("Nowa Sesja"),
